...
class App(Display):
    ...
    def __init__(self, parent=None, args=None, macros=None):
        ...
        self.MR1K1 = HOMS_state('MR1K1',status=self.ui.MR1K1_status)
        self.MR1K3 = HOMS_state('MR1K3',status=self.ui.MR1K3_status)
        self.MR2K3 = HOMS_state('MR2K3',status=self.ui.MR2K3_status)
        self.MR1K4 = HOMS_state('MR1K4',status=self.ui.MR1K4_status)
        self.mirror_list = [self.MR1K1, self.MR1K3, self.MR2K3, self.MR1K4]
